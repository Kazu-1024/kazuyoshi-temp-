    ...
    <div className="relative" onClickCapture={handleOutsideClick}>
      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-20 bg-gray-500 bg-opacity-50">
          <div ref={dialogRef} className="w-11/12 max-w-sm bg-white rounded-lg shadow-lg">
            <div className='bg-gray-700 rounded-t-lg flex items-center p-2'>
              <img src={hamburgerIcon} alt="" className='h-4 w-4 ml-2' />
              <p className='text-white font-bold ml-4'>MENU</p>
              <button
                onClick={closeMenu}
